...
const translations = {
  en: {
    ...
    archivist: 'Archivist',
    board: 'Internet Museum by Émile Gagnon, GEEK FACTORY',
    id: 'Item ID',
    ...
    copyrightNotice: 'For copyright removal requests, please contact: copyrights@geek-factory.xyz',
    buyCoffee: 'Buy Émile a Coffee',
